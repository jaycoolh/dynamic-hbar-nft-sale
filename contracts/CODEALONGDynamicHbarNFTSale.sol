...
contract DynamicHbarNFTSale is Ownable, HederaTokenService, KeyHelper {
    ...
    /**
     * @dev Fetches the latest BTC/USD price from Chainlink.
     * @return price The latest BTC price in USD with 8 decimals.
     */
     ...
     * @return btcAmount The equivalent amount in HBAR (with 18 decimals).
     */
    ...
    function getLatestHBARPrice() public view returns (int256 price) {
        ...
        ) = priceFeedHbarUsd.latestRoundData();
        return answer;
    }
